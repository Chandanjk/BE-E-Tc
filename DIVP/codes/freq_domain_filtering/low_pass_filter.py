...
plt.subplot(3, 2, 3), plt.imshow(filtered_img, 'gray'),plt.title('Low Pass Filtered Image')
plt.subplot(3, 2, 2), plt.hist(img.ravel(),256,[0,256]),plt.title('Histogram of Original Image')
plt.subplot(3, 2, 4), plt.hist(filtered_img.ravel(),256,[0,256]),plt.title('Histogram of Low Pass Filtered Image')
plt.subplot(3, 2, 5), plt.imshow(filter, 'gray'),plt.title('Low Pass Filter')
plt.subplot(3, 2, 6), plt.imshow(filtered_img, 'gray'),plt.title('Low Pass Filtered Image')
plt.show()