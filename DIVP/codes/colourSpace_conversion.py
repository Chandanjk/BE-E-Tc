...
img = cv2.imread('Images/flower2.jpg' , cv2.IMREAD_COLOR)
...
plt.subplot(2, 2, 2), plt.imshow(hsi),plt.title('HSI Image')
plt.subplot(2, 2, 3), plt.imshow(yiq),plt.title('YIQ Image')
plt.subplot(2, 2, 4), plt.imshow(cmy),plt.title('CMY Image')
